...
// Add request metadata logging middleware without sensitive header values.
app.Use(async (context, next) =>
{
    ...
    logger.LogInformation(
        "Incoming request {Method} {Path}{QueryString}. CorrelationId={CorrelationId}; TraceParent={TraceParent}",
